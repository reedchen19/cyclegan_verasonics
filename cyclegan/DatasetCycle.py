...
class DatasetCycle:
    def __init__(self, batch_size=1):
        ...
        train_y_df = pd.read_csv(
            './MimickNet/online_muscle_datasets_grayscale/train_dataset.csv')
        train_y = train_y_df['filename'].tolist()

        val_y_df = pd.read_csv(
            './MimickNet/online_muscle_datasets_grayscale/val_dataset.csv')
        val_y = val_y_df['filename'].tolist()

        test_y_df = pd.read_csv(
            './MimickNet/online_muscle_datasets_grayscale/test_dataset.csv')
